        ...
        <Accordion allowZeroExpanded>
          ...
          <AccordionItem>
            ...
            <AccordionItemPanel className="text-white font-bold px-10 text-xl">
              ...
              across multiple components in your application.You might create a
              custom hook when you find yourself repeating a specific pattern of
              state management or when you want to encapsulate and reuse a
              specific behavior across different components. By creating a
              custom hook, you can keep your components lean and focused on
              their specific responsibilities while maintaining the reusability
